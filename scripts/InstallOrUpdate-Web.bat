...
REM ============================================================================
REM   Скиллы из репы: ТОЛЬКО новые (существующие улучшения НЕ перезаписываем!)
REM ============================================================================
echo.
...
if exist "%SCRIPTS_DIR%\skills" (
    ...
    if errorlevel 8 (
        ...
        echo   %ESC%[1;32m+ %ESC%[0m Скиллы: новые установлены, существующие сохранены.
    )
) else (
...
REM ============================================================================
echo.
call "%SCRIPTS_DIR%\Open-Firewall-Port-Auto.bat" 9119 "Hermes Web"
