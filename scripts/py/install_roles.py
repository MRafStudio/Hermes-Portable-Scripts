...
# Логика: для каждого файла roles\<имя>.md: если agent.personalities.<имя> ОТСУТСТВУЕТ в config.yaml — установить.
# Роли в репо (scripts\roles\) — источник правды: при переустановке не теряются.
