...
Использование
-------------
    python scripts/py/restart_hermes_dashboard.py   # найти службу и перезапустить
    python scripts/py/restart_hermes_dashboard.py --list
    python scripts/py/restart_hermes_dashboard.py --name "HermesGateway (D:_NEURO_Hermes)"
"""
